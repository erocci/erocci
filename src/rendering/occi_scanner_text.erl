...
-module(occi_scanner_text).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/rendering/occi_scanner_text.xrl", 31).
...
-file("src/rendering/occi_scanner_text.erl", 320).
yystate() -> 16.
...
yystate(30, [35|Ics], Line, Tlen, _, _) ->
    yystate(30, Ics, Line, Tlen+1, 9, Tlen);
yystate(30, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 58 ->
    yystate(30, Ics, Line, Tlen+1, 9, Tlen);
...
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(8, Ics, Line, Tlen+1, 1, Tlen);
yystate(23, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(8, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(16, [123|Ics], Line, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [104|Ics], Line, Tlen, Action, Alen) ->
...
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 58, C =< 62 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 103 ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Tlen, Action, Alen) when C >= 105, C =< 122 ->
    yystate(13, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/rendering/occi_scanner_text.xrl", 16).
yyaction_0(TokenChars, TokenLine) ->
     make_atom (list_to_atom (TokenChars), TokenLine) .

-compile({inline,yyaction_1/1}).
-file("src/rendering/occi_scanner_text.xrl", 17).
yyaction_1(TokenLine) ->
     make_atom (quote, TokenLine) .

-compile({inline,yyaction_2/0}).
-file("src/rendering/occi_scanner_text.xrl", 18).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/2}).
-file("src/rendering/occi_scanner_text.xrl", 20).
yyaction_3(TokenChars, TokenLine) ->
     make_term_or_atom (TokenChars, TokenLine) .

-compile({inline,yyaction_4/1}).
-file("src/rendering/occi_scanner_text.xrl", 21).
yyaction_4(TokenLine) ->
     make_atom ('?action=', TokenLine) .

-compile({inline,yyaction_5/2}).
-file("src/rendering/occi_scanner_text.xrl", 22).
yyaction_5(TokenChars, TokenLine) ->
     make_token (attribute_name_attr, TokenLine, TokenChars) .

-compile({inline,yyaction_6/2}).
-file("src/rendering/occi_scanner_text.xrl", 23).
yyaction_6(TokenChars, TokenLine) ->
     make_token (quoted_value, TokenLine, unquote (TokenChars)) .

-compile({inline,yyaction_7/2}).
-file("src/rendering/occi_scanner_text.xrl", 24).
yyaction_7(TokenChars, TokenLine) ->
     make_token (integer, TokenLine, list_to_integer (TokenChars)) .

-compile({inline,yyaction_8/2}).
-file("src/rendering/occi_scanner_text.xrl", 25).
yyaction_8(TokenChars, TokenLine) ->
     make_token (float, TokenLine, list_to_float (TokenChars)) .

-compile({inline,yyaction_9/2}).
-file("src/rendering/occi_scanner_text.xrl", 26).
yyaction_9(TokenChars, TokenLine) ->
     make_token (url, TokenLine, TokenChars) .

-compile({inline,yyaction_10/2}).
-file("src/rendering/occi_scanner_text.xrl", 27).
yyaction_10(TokenChars, TokenLine) ->
     make_token (path, TokenLine, TokenChars) .
