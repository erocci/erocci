...
% 
% @doc Test creation of a link on a existing ID.
% expect: 409(conflict)
% end
%
put_link(_Config) ->
...
%
% @doc Test creation of a collection kind on a collection ID
...
%
% @doc Test creation of a collection mixin on a collection ID
% expect: 201(created)
% end
%
...
%
% @doc Test updating of a existing resource 
% expect: 200(ok)
% end 
%
...
%
% @doc Test creation two resources on differents ID for testing get_dir.
% expect: 201(created)
% end
% 
